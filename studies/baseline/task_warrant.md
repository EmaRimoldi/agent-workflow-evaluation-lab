...
This study chooses the starting `autoresearch/train.py` for later agent
workflow comparisons. It is not itself an agent experiment.

## Why A Starting Model Is Needed

Later studies will compare workflows such as single-agent, parallel, shared
...
The role of this study is therefore narrow: select a credible starting
...
- later agent studies mix 585-update and 1170-update results in the same claim.

## Claim Supported By This Study

This study supports a limited but important claim:
