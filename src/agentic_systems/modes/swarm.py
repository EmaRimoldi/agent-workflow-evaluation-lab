...
`agentic_systems.communication`. Full swarm execution delegates to the imported
runtime under `agent_parallelization_new.imported_swarms` until ownership moves
...
def run_swarm(argv=None) -> None:
    ...
    The implementation remains in `agent_parallelization_new.imported_swarms`
    during this compatibility phase.
    """
    from agent_parallelization_new.imported_swarms.launcher import main_imported_swarm
